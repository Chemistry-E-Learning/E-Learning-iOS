//
//  ElementDetailViewModelTests.swift
//  ChemistryARTests
//
...
class ElementDetailViewModelTests: XCTestCase {
    func test_getElementDetail_success() {
    ...
    func test_getElementDetail_fail() {
        let useCase = LessonUseCaseTest()
        let viewModel = LessonDetailViewModel(lessonID: "lessonID", useCase: useCase)
        let detailLesson = Lesson.emptyData
    ...
    func test_getElementDetail_empty() {
        let useCase = LessonUseCaseTest()
        let viewModel = LessonDetailViewModel(lessonID: "lessonID", useCase: useCase)
        let detailLesson = Lesson.emptyData
        useCase.result = .success(detailLesson)
